function fish_prompt
    ...
    $HOME/bin/powerline-go -shell bare -colorize-hostname -newline -modules nix-shell,venv,user,host,ssh,cwd,docker,dotenv,kube,perms,git,hg,jobs,exit,root,vgo 
