function __bobthefish_colors -S -a color_scheme -d 'Define colors used by bobthefish'
  switch "$color_scheme"
    ...
    case 'base16-tomorrow-night'
      set -l base00 1d1f21 # Base 00 - Black
      set -l base01 282a2e # Base 01
      set -l base02 373b41 # Base 02
      set -l base03 969896 # Base 03 - Bright Black
      set -l base04 b4b7b4 # Base 04
      set -l base05 c5c8c6 # Base 05 - White
      set -l base06 e0e0e0 # Base 06
      set -l base07 ffffff # Base 07 - Bright White
      set -l base08 cc6666 # Base 08 - Red
      set -l base09 de935f # Base 09 - orange
      set -l base0A f0c674 # Base 0A - Yellow
      set -l base0B b5bd68 # Base 0B - Green
      set -l base0C 8abeb7 # Base 0C - Cyan
      set -l base0D 81a2be # Base 0D - Blue
      set -l base0E b294bb # Base 0E - Magenta # violet
      set -l base0F a3685a # Base 0F - brown

      set -l colorfg $base05
