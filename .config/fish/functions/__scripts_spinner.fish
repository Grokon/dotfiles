# https://github.com/ByScripts/fish-config/blob/master/functions/__byscripts_spinner.fish
#doc
...
function __scripts_spinner --description 'Display a spinner while a process is running' --argument pid
    set -l delay 0.5
    set -l spinstr \| \/ \- \\
    set -l index 1
